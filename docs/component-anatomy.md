...
| `Popover`     | `popover-trigger`, `popover-content`, `popover-close`                                                                                         | None                                                                                            | Use for lightweight rich floating content.                              | Do not use for menus; use `Dropdown` or `Menu`.                            |
...
| `Menu`        | `menu-content`, `menu-item`, `menu-group`, `menu-label`, `menu-separator` plus submenu state attributes.                                      | None                                                                                            | Use for application menus.                                              | Do not recreate menus from dropdown items when submenu behavior is needed. |
| `Menubar`     | `menubar`, `menubar-trigger`, `menubar-content`, `menubar-item`, `menubar-group`, `menubar-label`, `menubar-separator`, `menubar-sub-trigger` | None                                                                                            | Use for persistent menu bars.                                           | Do not use for ordinary top navigation links.                              |
