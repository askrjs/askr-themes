...
const ALIAS_CONTRACTS = [
  ...
  ["layout/patterns.css", ".page-header", '[data-slot="page-header"]'],
  ["layout/patterns.css", ".page-header-content", '[data-slot="page-header-content"]'],
  ["layout/patterns.css", ".page-header-eyebrow", '[data-slot="page-header-eyebrow"]'],
  ["layout/patterns.css", ".page-header-title", '[data-slot="page-header-title"]'],
  ["layout/patterns.css", ".page-header-description", '[data-slot="page-header-description"]'],
  ["layout/patterns.css", ".page-header-meta", '[data-slot="page-header-meta"]'],
  ["layout/patterns.css", ".page-header-actions", '[data-slot="page-header-actions"]'],
  ...
  ["layout/patterns.css", ".form-section", '[data-slot="form-section"]'],
  ["layout/patterns.css", ".form-section-header", '[data-slot="form-section-header"]'],
  ["layout/patterns.css", ".form-section-heading", '[data-slot="form-section-heading"]'],
  ["layout/patterns.css", ".form-section-title", '[data-slot="form-section-title"]'],
  ["layout/patterns.css", ".form-section-description", '[data-slot="form-section-description"]'],
  ["layout/patterns.css", ".form-section-actions", '[data-slot="form-section-actions"]'],
  ["layout/patterns.css", ".form-section-content", '[data-slot="form-section-content"]'],
