...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      'import { Block, Box, Heading, Inline, PageHeader, Stack, Toolbar, type BlockProps, type DialogProps, type GridProps, type HeadingProps, type LegacyLayoutProps, type SidebarRailProps, type TextProps } from "@askrjs/themes/components";',
      'import { withThemeStyles } from "@askrjs/themes/ssr";',
      "const fixture = <Block><span>strict consumer</span></Block>;",
      'const granular = <GranularPage><GranularPageHeader title="Status" /><GranularContainer><GranularSection><GranularBlock direction="column"><GranularGrid columns={2}><GranularText>one</GranularText><GranularText>two</GranularText></GranularGrid></GranularBlock></GranularSection></GranularContainer></GranularPage>;',
      ...
      'const invalidLegacySize = Box({ minWidth: { base: "100%", sm: "18rem" } });',
      "// @ts-expect-error legacy aliases reject misspelled layout props",
      'const invalidLegacyProp = Stack({ directon: "row" });',
