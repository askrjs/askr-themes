...
const ALIAS_CONTRACTS = [
  ...
  ["display/list-group.css", ".list-group", '[data-slot="list-group"]'],
  ["display/list-group.css", ".list-group-flush", '[data-slot="list-group"][data-flush="true"]'],
  [
    "display/list-group.css",
    ".list-group-horizontal",
    '[data-slot="list-group"][data-orientation="horizontal"]',
  ],
  ["display/list-group.css", ".list-group-item", '[data-slot="list-group-item"]'],
  [
    "display/list-group.css",
    ".list-group-item-action",
    '[data-slot="list-group-item"][data-action="true"]',
  ],
  [
    "display/list-group.css",
    ".list-group-item.active",
    '[data-slot="list-group-item"][data-active="true"]',
  ],
  [
    "display/list-group.css",
    ".list-group-item.disabled",
    '[data-slot="list-group-item"][data-disabled="true"]',
  ],
  ...
  ["navigation/nav.css", ".nav", '[data-slot="nav"]'],
  ["navigation/nav.css", ".nav-item", '[data-slot="nav-item"]'],
  ["navigation/nav.css", ".nav-item-icon", '[data-slot="nav-item"][data-variant="icon"]'],
  ...
  ["shell/navbar.css", ".navbar-group-body", '[data-slot="navbar-group-body"]'],
  ["shell/navbar.css", ".navbar-group-label", '[data-slot="navbar-group-label"]'],
  ["navigation/nav.css", ".navbar-item", '[data-slot="nav-item"]'],
  ["navigation/nav.css", ".navbar-item-icon", '[data-slot="nav-item"][data-variant="icon"]'],
